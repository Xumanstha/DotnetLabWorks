...
namespace Lab_5And6
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //----------------------------Lab-6------------------------------------------
            NotesApp example=new NotesApp();
            example.SetupNoteDirectory();
            ...
            example.ReadNote("CSharp");

            example.ListAllNotes();

            example.CopyNote("CSharp", "CSharpBackup");

            example.MoveNote("CSharpBackup", "CSharpCopy");

            example.ReadNoteLineByLine("CSharp");

            example.DeleteNote("CSharpCopy");
        }
    }
}
